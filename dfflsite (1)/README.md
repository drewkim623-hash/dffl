...
- **Records** — trophy case and the all-time record book, plus the 10 best and worst weeks ever
- **Matchups** — a "pick two managers" comparison, the full head-to-head grid, rivalries, and a
  season browser
...
390px on every section. Run `node verify.mjs` — 35 checks, all must pass.
