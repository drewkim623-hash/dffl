...
Sections: Overview (power rankings + scoring), All-Time standings, Trophy Case, Record Book,
Head-to-Head grid, Luck Index, Season browser, Weekly Recaps.
...
official standings. Run `node verify.mjs` — 23 checks, all must pass.
